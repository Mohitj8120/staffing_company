            ...
            <section className="py-24 px-6 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                >
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed mb-6">
                        Averion Group was founded on a simple realization: the traditional job application process is broken for international candidates. Between ATS filters and the high bar of technical interviews, brilliant talent often goes overlooked.
                    </p>
            ...
            <section className="py-24 bg-white border-y border-gray-200">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-lg text-gray-500 max-w-2xl mx-auto">The core pillars that make Averion Group the #1 choice for placement success.</p>
                    </div>
