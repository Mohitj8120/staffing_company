...
export default function HeroVideo() {
    ...
    return (
        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-blue-800 via-blue-700 to-gray-100 text-white pt-40 pb-32 m-4 md:m-8 rounded-[40px] border border-white/20 shadow-sm">
            ...
            <div className="max-w-6xl mx-auto text-center px-6">
                ...
                <motion.h2
                    ...
                    className="text-4xl italic font-light mt-2 text-blue-200">
                ...
                <p className="mt-6 text-blue-100 max-w-xl mx-auto">
                    ...
                    Grow your reach, earn more, and save time so you can focus on delivering
                ...
                <h3 className="mt-20 text-gray-700 text-lg font-semibold">
