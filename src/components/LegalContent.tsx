    ...
    return (
        <div className="w-full bg-slate-50 min-h-screen font-sans pt-32 pb-24">
            <div className="max-w-4xl mx-auto px-6">
                ...
                >
                    If you have any questions regarding our policies, please contact us at <a href="mailto:legal@talentra.io" className="text-purple-600 font-bold hover:underline">legal@talentra.io</a>
                </motion.div>
            </div>
